...
class PupilsControllerTest < ActionController::TestCase
  ...
  test "should create pupil" do
    assert_difference('Pupil.count') do
      post :create, pupil: { hort: @pupil.hort, klasse: @pupil.klasse, nachname: @pupil.nachname, vorname: @pupil.vorname }
    end
  ...
  test "should update pupil" do
    patch :update, id: @pupil, pupil: { hort: @pupil.hort, klasse: @pupil.klasse, nachname: @pupil.nachname, vorname: @pupil.vorname }
    assert_redirected_to pupil_path(assigns(:pupil))
  end
